class Kryofetch < Formula
  ...
  on_arm do
    url "https://github.com/t3m3d/kryofetch/releases/download/v1.2.31/kryofetch-1.2.31-macos-arm64.tar.gz"
    sha256 "5e01dfe7e12fbe73f60dfe96a6db97d67c81041c5b9ec5cc4e717baf1a6df347"
  end
