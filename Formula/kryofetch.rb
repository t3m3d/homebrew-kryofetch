class Kryofetch < Formula
  ...
  on_arm do
    url "https://github.com/t3m3d/kryofetch/releases/download/v1.2.26/kryofetch-1.2.26-macos-arm64.tar.gz"
    sha256 "ca53567a50611a0365dd6b1193cf8155284ba4210be605d765c9e9b0e4dd4695"
  end
