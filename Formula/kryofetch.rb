class Kryofetch < Formula
  ...
  on_arm do
    url "https://github.com/t3m3d/kryofetch/releases/download/v1.2.24/kryofetch-1.2.24-macos-arm64.tar.gz"
    sha256 "c72d76619547df10071e6294c1041be3810c5368becd62cd1a00c33035dcf5d7"
  end
