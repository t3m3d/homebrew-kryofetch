class Kryofetch < Formula
  ...
  on_arm do
    url "https://github.com/t3m3d/kryofetch/releases/download/v1.2.18/kryofetch-1.2.18-macos-arm64.tar.gz"
    sha256 "7e465c681fe748ca5d2f3c2a3d7cc86b87ed10027e4de581b7d143a2e5973b5b"
  end
