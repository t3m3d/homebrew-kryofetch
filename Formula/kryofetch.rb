class Kryofetch < Formula
  ...
  on_arm do
    url "https://github.com/t3m3d/kryofetch/releases/download/v1.2.22/kryofetch-1.2.22-macos-arm64.tar.gz"
    sha256 "bba03b16a76c054bacc1da074994ca31cdd83ff7ecf544a8699b146c8be8d7d1"
  end
