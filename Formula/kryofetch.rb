class Kryofetch < Formula
  ...
  on_arm do
    url "https://github.com/t3m3d/kryofetch/releases/download/v1.2.12/kryofetch-1.2.12-macos-arm64.tar.gz"
    sha256 "400771b0519573410860f669628a6e110e03e4dfbac343a74577a2b3b3ecac14"
  end
